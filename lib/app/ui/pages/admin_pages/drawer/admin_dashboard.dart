...
import 'package:final_tpc_app/app/ui/pages/admin_pages/drawer/HomeScreen/DeptStudentList/department_list.dart';
...
class AdminDash extends StatelessWidget {
  ...
  AdminDash({Key? key, required this.admin}) : super(key: key);
                        ...
                        return GestureDetector(
                          onTap: () {
                            if (controller.catNames[index] ==
                                "Dept Student List") {
                              Get.to(() => DepartmentList());
                            } else if (controller.catNames[index] ==
                                "Post Job") {
                              Get.to(() => PostNewJob());
                            } else if (controller.catNames[index] ==
                                "Non Willing") {
                              // Get.to(() => NonWillingStudents());
                            }
