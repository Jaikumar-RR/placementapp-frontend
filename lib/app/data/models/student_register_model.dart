...
StudentRegisterModel studentRegisterModelFromJson(String str) => StudentRegisterModel.fromJson(json.decode(str));

String studentRegisterModelToJson(StudentRegisterModel data) => json.encode(data.toJson());
...
class StudentRegisterModel {
    ...
    final int yop12Th;
    final dynamic scoreDiploma;
    final dynamic branchDiploma;
    final dynamic yopDiploma;
    final double cgpa;
    ...
    factory StudentRegisterModel.fromJson(Map<String, dynamic> json) => StudentRegisterModel(
