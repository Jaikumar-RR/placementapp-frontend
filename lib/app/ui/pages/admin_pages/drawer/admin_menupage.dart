import 'package:final_tpc_app/app/controllers/admin_pages_controller/drawer_controller/admin_menupage_controller.dart';
...
class AdminMenuPage extends StatelessWidget {
  ...
  AdminMenuPage({Key? key, required this.selectedIndex, required this.admin})
      : super(key: key);
    ...
    return Obx(() {
      return SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<AdminMenuController>(
            init: AdminMenuController(selectedIndex.obs, admin),
            builder: (controller) {
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ListView.builder(
                        itemCount: AdminMenuOptions.adminOptions.length,
                        itemBuilder: (BuildContext context, int index) {
                          final option = AdminMenuOptions.adminOptions[index];
                          return ListTile(
