...
import '../../../../../../controllers/admin_pages_controller/drawer_controller/HomeScreenController/DeptStudentListController/student_list_controller.dart';

class DeptStudentList extends StatelessWidget {
  final String department;

  const DeptStudentList({super.key, required this.department});

  @override
  Widget build(BuildContext context) {
    final ThemeController themeController = Get.find<ThemeController>();
    final DeptStudentListController controller =
        Get.put(DeptStudentListController());
