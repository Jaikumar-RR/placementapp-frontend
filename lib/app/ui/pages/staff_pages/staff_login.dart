...
import 'package:final_tpc_app/app/controllers/login_contoller/staff_login_controller.dart';
...
class StaffLoginPage extends StatelessWidget {
  ...
  final StaffLoginController controller = Get.put(StaffLoginController());

  StaffLoginPage({super.key});
  ...
  Widget makeInput({required String label, bool obscureText = false}) {
    final StaffLoginController controller = Get.find<StaffLoginController>();
